...
import pickle
import torch
from loss import ContrastiveLoss, ContrastiveLoss_all
from option import parser, verify_input_args
import data
from vocab import Vocabulary
from MANME_modle import MANME
...
def train_model(epoch, data_loader, model, criterion, criterion_contraloss_7, criterion_contraloss_14, criterion_contraloss_28, optimizer, args):
	...
	for itr, data in enumerate(data_loader):
		...
		scores, scores_14, scores_28, A_IS_all_t, A_IS_all_t_14, A_IS_all_t_28, A_EM_all_t, A_EM_all_t_14, A_EM_all_t_28, m, Tr_m = model.forward_broadcast(img_src, img_trg, txt, txt_len)
		...
		loss_14 = criterion(scores_14)
		loss_28 = criterion(scores_28)
		loss = loss + loss_14 + loss_28
...
def main():
	...
	if args.model_version == "TIRG":
		...
		model = MANME(vocab.word2idx, args)
	...
	criterion_contraloss = ContrastiveLoss(args, margin=0.6)
	criterion_contraloss_14 = ContrastiveLoss(args, margin=0.3)
	criterion_contraloss_28 = ContrastiveLoss(args, margin=0.25)
