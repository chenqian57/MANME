...
if __name__ == '__main__':
  ...
  parser.add_argument('--data_name', default='fashion200K', choices=('fashionIQ', 'shoes', 'cirr', 'fashion200K'), help='Name of the dataset for which to build the vocab (fashionIQ|shoes|cirr|fashion200K)')
