...
parser.add_argument('--model_version', default='MANME', choices=('MANME', "TIRG"), help='Model version')
...
parser.add_argument('--txt_enc_type', default='lstm', choices=('bigru', 'lstm'), help="The text encoder (bigru|lstm).")
...
parser.add_argument('--step_lr', default=20, type=int, help="Step size, number of epochs after which to apply a learning rate decay.")
...
parser.add_argument('--img_finetune', default=True, help='Fine-tune CNN image encoder.')
parser.add_argument('--txt_finetune', default=True, help='Fine-tune the word embeddings.')
...
parser.add_argument('--studied_split', default="test", help="Split to be used for the computation (this does not impact the usual training & validation pipeline, but impacts other scripts (for evaluation or visualizations purposes)).")
